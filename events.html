		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					  ...
					  <p>Mantente al tanto de nuestras actividades.</p>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-md-12 col-sm-12" id="events">
				...
				<div class="evento">
					<div class="evento-imagen">
						<figure>
							<img src="img/ibms-logo2.png" alt="">
						</figure>
					</div>
					
					<div class="evento-descripcion">
						<h2>Evento</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam illo, consectetur facilis hic quae alias! Voluptate cum suscipit aperiam veritatis dolor excepturi, ab dicta, hic, voluptates illo, quas. Molestias, nobis.</p>
					</div>
